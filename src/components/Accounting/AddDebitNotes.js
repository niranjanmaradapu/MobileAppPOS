        ...
        return (
            <View style={styles.mainContainer}>
                ...
                <TextInput
                    ...
                    onChangeText={this.handleTotalAmmount}
                /><TextInput
                    style={Device.isTablet ? styles.input_tablet : styles.input_mobile}
                    underlineColorAndroid="transparent"
                    ...
                    textAlignVertical="center"
                    autoCapitalize="none"
                    value={this.state.paidAmmount}
                    onChangeText={this.handlePaidAmmount}
                /><TextInput
                    style={Device.isTablet ? styles.input_tablet : styles.input_mobile}
                    underlineColorAndroid="transparent"
                    placeholder="BALANCE AMMOUNT"
                    placeholderTextColor="#6F6F6F"
                    textAlignVertical="center"
                    autoCapitalize="none"
                    value={this.state.balanceAmmount}
                    onChangeText={this.handleBalanceAmmount}
                />

...
class InventoryRetail extends Component {
  constructor(props) {
    super(props);
    this.camera = null;
    this.barcodeCodes = [];
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={Device.isTablet ? styles.viewsWidth_tablet : styles.viewsWidth_mobile}>
          ...
          <Text style={Device.isTablet ? styles.headerTitle_tablet : styles.headerTitle_mobile}> Inventory Portal </Text>
          {/* <TouchableOpacity
...
export default InventoryRetail;

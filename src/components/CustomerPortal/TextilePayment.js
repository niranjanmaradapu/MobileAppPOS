                ...
                <View style={styles.container}>
                    ...
                    <ScrollView>
                        <View style={styles.container}>
                            ...
                            <Text style={{ fontSize: 12, fontFamily: 'medium', color: '#828282', marginLeft: 10, marginTop: 15 }}> SELECT A MODE TO PAY ₹ {(parseFloat(this.state.totalAmount + this.state.CGST * 2) - parseFloat(this.state.totalDiscount) - parseFloat(this.state.promoDiscount) - parseFloat(this.state.redeemedPints / 10)).toString()} </Text>
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    if (item.key === 1) {
                                        return <View style={{
                                            ...
                                            <Text style={{ fontSize: 15, alignItems: 'center', alignSelf: 'center', marginTop: 0, fontSize: 14, color: this.state.flagOne && this.state.flagThree === false ? "#ED1C24" : "#22222240", fontFamily: 'regular' }}>
                                                CASH
                                            </Text>
                            ...
                            <Text style={{ fontSize: 12, fontFamily: 'medium', color: '#828282', marginLeft: 10, marginTop: 10 }}> {('HAVE A RT NUMBER?')} </Text>
                            ...
                            <Text style={{ fontSize: 12, fontFamily: 'medium', color: '#828282', marginLeft: 10, marginTop: 10 }}> {('HAVE A COUPON CODE ?')} </Text>
                            ...
                            {this.state.flagOne === true && this.state.verifiedCash !== "" && (
                                <View style={{ backgroundColor: '#ffffff', marginTop: 0 }}>
                                    <Text style={{ fontSize: 12, fontFamily: 'medium', color: '#ED1C24', marginLeft: 10, marginTop: 10 }}> RETURN AMOUNT  ₹{this.state.returnAmount} </Text>
